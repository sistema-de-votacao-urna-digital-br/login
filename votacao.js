// ============================================================================
// URNA ELETRÔNICA - votacao.js (Fluxo Completo de Configuração e Votação)
// ============================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let chaveRealMestra = "674267"; // Senha padrão da chave mestra
    let legendaAtual = {};
    ...
    // ========================================================================
    // TELA 2: CADASTRO DE CANDIDATOS E QUANTIDADE DE DÍGITOS
    // ========================================================================
    ...
    // ========================================================================
    // LOGICA DA CHAVE MESTRA E LEGENDA COM TECLA W + BOTÃO VOLTAR
    // ========================================================================
    ...
    if (btnConfirmarMaster) {
        btnConfirmarMaster.addEventListener('click', () => {
            let digitado = inputMaster.value.trim();
            if (digitado === chaveRealMestra) {
            ...
            if (candidatoEncontrado) {
                ...
                if (visorInfoCandidato) {
                    if (configVotacao.permiteNulo) {
                        ...
                        visorInfoCandidato.innerHTML = `<p style="color: orange;">Código inválido (Nulo desativado)</p>`;
                    }
                }
            }
        } else {
